...
#fwrite(GenMat2012_4, file="script_output/SurveyData/20210701_ParentageMatrix2012-14ForROMSComp.csv")
#fwrite(GenMat2012, file="script_output/SurveyData/20210701_ParentageMatrix2012ForROMSComp.csv")
#fwrite(GenMat2013, file="script_output/SurveyData/20210701_ParentageMatrix2013ForROMSComp.csv")
#fwrite(GenMat2014, file="script_output/SurveyData/20210701_ParentageMatrix2014ForROMSComp.csv")
#fwrite(GenMatNEM, file="script_output/SurveyData/20210701_ParentageMatrixNEM2012-14ForROMSComp.csv")
#fwrite(GenMatSWM, file="script_output/SurveyData/20210701_ParentageMatrixSWM2012-14ForROMSComp.csv")
